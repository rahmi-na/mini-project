...
<div class="bg-white dark:bg-gray-900 py-8 px-4 mx-auto max-w-2xl lg:py-16">
    <h2 class="mb-6 text-2xl font-bold text-gray-900 dark:text-white">Add a New Method</h2>

    <form action="{{ route('method.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
